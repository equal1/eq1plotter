...
###################################################################
    ...
    def __init__( self ):
      ...
      txt = '$Revision: 1.243 $'                   # sos revision number, auto assigned by sos when doing a checkin
...
#                 print sdai, self.data['linenumber'][trn]  , self.data['//T#'][trn], self.data['TestName'][trn],  self.data['Test Freq(MHz)'][trn], sda
                  ...
                  if plottype not in  ['contour','polar_phase_plot'] and( xynames[0] == 'Frequency of Spur (MHz)' or self.sort_data_on.get() ) :
